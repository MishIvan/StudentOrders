...
// ButtonPhone.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CButtonPhoneApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CButtonPhoneApp

CButtonPhoneApp::CButtonPhoneApp()
{
...
// Единственный объект CButtonPhoneApp

CButtonPhoneApp theApp;


// Инициализация CButtonPhoneApp

BOOL CButtonPhoneApp::InitInstance()
{
