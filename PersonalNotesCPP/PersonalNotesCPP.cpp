...
// PersonalNotesCPP.cpp: определяет поведение классов для приложения.
//
...
// CPersonalNotesCPPApp

BEGIN_MESSAGE_MAP(CPersonalNotesCPPApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CPersonalNotesCPPApp

CPersonalNotesCPPApp::CPersonalNotesCPPApp()
{
...
// Единственный объект CPersonalNotesCPPApp

CPersonalNotesCPPApp theApp;


// Инициализация CPersonalNotesCPPApp

BOOL CPersonalNotesCPPApp::InitInstance()
{
